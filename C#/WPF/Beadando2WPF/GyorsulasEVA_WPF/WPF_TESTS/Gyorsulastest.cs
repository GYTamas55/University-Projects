...
namespace Gyorsulas.Test
{
    ...
    public class GameTest
    {
        ...
        private Mock<GyorsulasEVA_WPF.Model.ITimer>? _mockTimer;

        [TestInitialize]
        public void Initialize()
        {
            _mockTimer = new Mock<GyorsulasEVA_WPF.Model.ITimer>(); //Mock timer has been added, with the package mock
        ...
        //PERSISTENCE
        [TestMethod]
        public async Task Save_ShouldWriteAllData()
        {
            // Act
            await _game!.SaveAsync(_mockFileManager!);
        ...
        [TestMethod]
        public async Task LoadGame_ShouldRestoreGameState()
        {
            // Arrange
            string saveData =
                "0,25|75\n" +
            ...
            // Act
            await _game!.LoadGameAsync(_mockFileManager);
    ...
    internal class MockFileManager : IFileManager
    {
        ...
        {
            return await Task.FromResult(MockLoadData);
        }
